...
本册为福安话分册，表示的是福安市区一带的闽东语方言。参见 link:main.html[**主方案**]。
...
NOTE: 数字声调标记部分已完成。其他位置还未按照声调进行更正。
...
声调 “数字” 按《班华字典》的音调标记方式。

[options="header,footer,autowidth"]
|===
| 调类 | 阴平 | 阳平 | 上 | 阳去 | 阴去 | 阳入 | 阴入 | 轻声
| 数字 | a¹ | a² | a³ | a⁴ | a⁵ | ak⁶ | ak⁷ | a⁰
| 五度 | a³³² | a²² | a⁴² | a⁴² | a³⁵ | ak² | ak⁵ | a⁰
| 例字
| 簪
